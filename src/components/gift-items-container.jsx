...
const GiftItemsContainer = () => {
  ...
  if (loading) {
    return (
      <div className="w-full sm:w-64 bg-white border-r border-gray-200 p-4">
  ...
  return (
    <div className="w-full sm:w-64 min-w-64 max-w-full sm:max-w-64 bg-white border-r border-gray-200 p-4 overflow-y-auto overflow-x-hidden flex-shrink-0">
