...
export default function FeedBack() {
  return (
    <section className='bg-[#FFF5F0] py-16 px-4 sm:px-6 lg:px-20 xl:px-32 w-full'>
      <div className='text-center'>
        <h2 className='text-3xl sm:text-4xl font-bold text-[#AD3542] mb-12'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
          {testimonials.map((item, idx) => (
            <div
              key={idx}
              className='bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between h-full border border-gray-200'
            >
              ...
              <p className='font-semibold text-[#AD3542] mb-2'>{item.name}</p>
